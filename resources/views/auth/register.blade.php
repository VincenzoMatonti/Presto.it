<x-shared.layout>
    ...
    <x-shared.section-title title="{{env('APP_NAME')}}" subtitle="{{__('ui.joinCommunity')}}" />
            ...
            <div class="col-12 col-md-6 height-custom mt-1">
                <form action="{{route('register')}}" method="POST" class="mybgsec shadow rounded p-5 mt-5">
                    ...
                    <div class="d-flex justify-content-center">
                        <button class="mybutton btn shadow mt-3" type="submit">{{__('ui.register')}} <i class="fa-solid fa-id-card"></i></button>
                    </div>
                </form>
            </div>
        </div>
